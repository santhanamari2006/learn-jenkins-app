pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = '2944553c-ce3f-4234-b0ca-99e918c813cb'
        NETLIFY_AUTH_TOKEN = credentials('netlifyweb')
        ...
        stage('AWS') {
            ...
            steps {
                ...
                sh '''
                  ...
                  aws s3 cp index.html s3://learn-jenkins-smari-web/index.html
                '''    
            }
            }
        }
